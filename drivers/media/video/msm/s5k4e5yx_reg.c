...
{0x300E, 0x2B}, /* Vertical Binning On */
...
/* improve shutter lag, not real zsl */
struct s5k4e5yx_i2c_reg_conf s5k4e5yx_full_settings_array_mipi_zsl[] =
{
{0x30BD, 0x00}, /* SEL_CCP[0] */
{0x3084, 0x15}, /* SYNC Mode */
{0x30BE, 0x1A}, /* M_PCLKDIV_AUTO[4], M_DIV_PCLK[3:0] */
...
struct s5k4e5yx_reg_t s5k4e5yx_regs = {
	...
	/* for impove shutter lag */
	.full_mipi_zsl = &s5k4e5yx_full_settings_array_mipi_zsl[0],
	.full_mipi_size_zsl = ARRAY_SIZE(s5k4e5yx_full_settings_array_mipi_zsl),
};
